    ...
    <Box>
      ...
      <Box
        sx={{
          ...
          mb: 6,
          minHeight: '250px',
          backgroundImage: 'url("https://images.unsplash.com/photo-1516062423079-7ca13cdc7f5a?auto=format&fit=crop&w=2000")',
      ...
      >
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2 }}>
          <Box sx={{ textAlign: 'center', py: 4 }}>
            <FindInPageIcon sx={{ fontSize: 64, mb: 2 }} />
            <Typography variant="h2" fontWeight="bold" gutterBottom>
              Report Found Item
            </Typography>
            <Typography variant="h6" sx={{ opacity: 0.95, maxWidth: '600px', mx: 'auto' }}>
              You found something? Great! Help reunite lost items with their owners by providing detailed information.
            </Typography>
          </Box>
        </Container>
      </Box>
          ...
          <Box component="form" onSubmit={handleSubmit}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <Card 
                  ...
                  sx={{ 
                    ...
                    borderWidth: 2,
                    borderColor: image ? '#2e7d32' : '#2e7d32',
                    backgroundColor: image ? 'rgba(46, 125, 50, 0.05)' : 'rgba(46, 125, 50, 0.02)',
                    transition: 'all 0.3s',
                    position: 'relative',
                    overflow: 'hidden'
                  }}
                >
                  <CardContent sx={{ p: 3 }}>
                    <Box sx={{ textAlign: 'center' }}>
                      <Typography variant="h6" gutterBottom color="#2e7d32" fontWeight={600}>
                        <ImageIcon sx={{ verticalAlign: 'middle', mr: 1 }} />
                        Upload Item Photo *
                      </Typography>
                      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                        A clear photo helps the owner identify their item (Max 2MB, JPG/PNG)
                      </Typography>
                      ...
                      <Button
                        ...
                        sx={{
                          py: 2,
                          backgroundColor: image ? 'transparent' : '#2e7d32',
                          borderColor: '#2e7d32',
                          color: image ? '#2e7d32' : 'white',
                          fontWeight: 600,
                          fontSize: '1rem',
                          '&:hover': {
                            borderColor: '#1b5e20',
                            backgroundColor: image ? 'rgba(46, 125, 50, 0.04)' : '#1b5e20'
                          }
                        }}
                      >
              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  <Typography variant="body2" color="text.secondary" component="div">
                    • Provide a clear photo of the found item
                    <br />
                    • Include detailed description (color, brand, condition)
                    <br />
                    • Mention any identifying marks or features
                    <br />
                    • Be accurate with date and location found
                  </Typography>
                </Box>
              </Grid>
              ...
              <Grid item xs={12}>
                ...
                >
                  {loading ? <CircularProgress size={24} color="inherit" /> : 'Report Found Item'}
                </Button>
              </Grid>
            </Grid>
          </Box>
